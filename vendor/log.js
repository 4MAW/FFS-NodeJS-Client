...
/**
 * Prints given warning info in console.
 * @param {string} status Information to print.
 * @param {string} label Label to print instead of "WARNING".
 */
...
/**
 * Prints given input info in console.
 * @param {string} status Information to print.
 * @param {string} label Label to print instead of "INPUT".
 */
function logInput( status, label )
{
